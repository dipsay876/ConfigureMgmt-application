...
public class ComponentMaster implements Serializable {
    ...
    @OneToOne(mappedBy = "componentName")
    @JsonIgnore
    private ConfigurationFile componentName;
    ...
    public ConfigurationFile getComponentName() {
        return componentName;
    }

    public ComponentMaster componentName(ConfigurationFile configurationFile) {
        this.componentName = configurationFile;
        return this;
    }

    public void setComponentName(ConfigurationFile configurationFile) {
        this.componentName = configurationFile;
    }
